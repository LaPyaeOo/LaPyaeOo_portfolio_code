...
import 'package:developer_portfolio/widget/service_card.dart';
      ...
      child: Column(
        children: [
          ...
          const CustomSectionSubHeading(
              text: "Let me contribute in your process :)\n\n"),
          Wrap(
    ...
    void launchEmail()async{
      ...
      final Uri emailLaunchUri = Uri(
        ...
        query: encodeQueryParameters(<String, String>{
          'subject': 'For job offer!'
        }),
      );
      String emailString = emailLaunchUri.toString();
      if(await canLaunchUrl(emailLaunchUri)){
          launchURL(emailString);
      }
      else{
        null;
      }
